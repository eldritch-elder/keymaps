...
| &nop | &kp r | &kp s | &kp n    | &kp d   | &kp w    |          |         |           |           | &kp comma | &kp a    | &kp e    | &kp o   | &kp i     | &nop |
| &nop | &kp x | &kp g | &kp l    | &kp c   | &kp b    | &mo _adj | &nop    | &tg _game | &nop      | &kp minus | &kp h    | &kp u    | &kp j   | &kp k     | &nop |
...
|      |          |          | &trns    | &trns     | &kp gesc | &trns | &trns | &trns | &trns | &trns    | &trns    | &trns  |           |       |      |
...
: KC_NO, KC_K, KC_F, KC_M, KC_P, KC_V, KC_SCOLON, KC_DOT, KC_SLASH, KC_QUOTE, KC_EQUAL, KC_NO, KC_NO, MT(MOD_LGUI, KC_R), MT(MOD_LALT, KC_S), MT(MOD_LSFT, KC_N), MT(MOD_LCTL, KC_D), KC_W, KC_COMMA, MT(MOD_RCTL, KC_A), MT(MOD_RSFT, KC_E), MT(MOD_LALT, KC_O), MT(MOD_RGUI, KC_I), KC_NO, KC_NO, KC_X, KC_Q, KC_L, KC_C, KC_B, MO(_adj), KC_GESC, TG(_game), KC_NO, KC_MINUS, KC_H, KC_U, KC_Z, KC_K, KC_NO, KC_LGUI, KC_TAB, KC_DEL, LT(_low, KC_T), KC_ENTER, KC_RALT, LT(_high, KC_SPACE), KC_BSPACE, KC_NO, KC_MUTE
...
: const uint16_t PROGMEM unique_combo0[] = { KC_Z, KC_F, KC_G, COMBO_END, };
